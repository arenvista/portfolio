        ...
        <div className="outline-text-2">
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td className="left-algin">Bedrich Sousedik: University of Maryland, Baltimore County</td>
              </tr>
              <tr>
                <td colSpan="3">
                  <ul>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td className="left-algin">Riadul Islam: University of Maryland, Baltimore County</td>
              </tr>
              <tr>
                <td colSpan="3">
                  <ul>
                    <li>Developed Spiking Neural Network for the classification of temporal data TBD</li>
                    <li>Developed CNN Networks for image classification TBD</li>
                  </ul>
                </td>
              </tr>
            </tbody>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td className="left-algin">National Institute of Health</td>
              </tr>
              <tr>
                <td colSpan="3">
                  <ul>
                    <li>Established and managed a software version control system using Git to streamline code branch management and release control, while coordinating development efforts across multiple laboratories.</li>
                    <li>Deployed unsupervised machine learning algorithms, specifically K-Means and DBSCAN, to cluster multivariate data for anomaly detection, resulting in the identification of key contributors to disease pathology.</li>
                    <li>Engineered an automated data processing pipeline utilizing SWARM and High-Performance Computing (HPC) environments to generate 3D amino acid structures from linear sequences. This optimization enhanced vector design, increasing packageable information in viral vectors.</li>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td className="left-algin">Seley Radtke Lab: University of Maryland, Baltimore County</td>
              </tr>
              <tr>
                <td colSpan="3">
                  <ul>
                    <li>Leveraged Python, BeautifulSoup (BS4), and Selenium to aggregate extensive drug databases for the documentation of approved nucleoside analogues.</li>
                    <li>Devised a synthetic pathway for preparing N-glycosylated imidazole 4-boronic acids, which improved reaction yields by 40%.</li>
                    ...
                    <li>Synthesized flexible nucleoside analogues to combat infectious diseases.</li>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td className="left-align">Vasta Lab - IMET</td>
              </tr>
              <tr>
                <td colSpan="3">
                  <ul>
                    ...
                    <li>Directed the standardization and optimization of protocols regarding protein purification, characterization, and modification.</li>
                    ...
                    <li>Categorized the carbohydrate recognition of ligands on Perkinsus Parasites and their impact on the Chesapeake</li>
                  </ul>
                </td>
              </tr>
            </tbody>
      ...
      <div id="teaching" className="outline-3">
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td className="left-algin">Stephen Freeland, Interm Vice-Provost: University of Maryland, Baltimore County</td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td className="left-algin">Osman Guler, Daniel Reynolds: University of Maryland, Baltimore County</td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td className="left-algin">Academic Sucess Center: University of Maryland, Baltimore County</td>
            </tr>
            <tr>
              <td colSpan="3">
                <ul>MATH 151 <b>Calculus and Analytic Geometry I</b></ul>
                <ul>MATH 152 <b>Calculus and Analytic Geometry II</b></ul>
                <ul>MATH 251 <b>Multivariate Calculus</b></ul>
                <ul>MATH 221 <b>Linear Algebra</b></ul>
                <ul>MATH 225 <b>Differential Equations</b></ul>
                <ul>MATH 300 <b>Mathematical Reasoning</b></ul>
                <ul>CMSC 201 <b>Computer Science I</b></ul>
                <ul>CMSC 202 <b>Computer Science II</b></ul>
                <ul>CMSC 341 <b>Data Structures</b></ul>
                <ul>CMSC 203 <b>Discrete Structures</b></ul>
                <ul>BIO 141 <b>Foundations of Biology</b></ul>
                <ul>PHYS 121 <b>Introductory Physics</b></ul>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td className="left-algin">Varsity Tutors</td>
            </tr>
            <tr>
              <td colSpan="3">
                <ul>All Prior Listed Courses</ul>
                <ul>CHEM 101 <b>Principles of Chemistry I</b></ul>
                <ul>CHEM 102 <b>Principles of Chemistry II</b></ul>
                <ul>CHEM 300 <b>Analytical Chemistry</b></ul>
                <ul>CHEM 351 <b>Organic Chemistry I</b></ul>
                <ul>CHEM 352 <b>Organic Chemistry II</b></ul>
              </td>
            </tr>
          </tbody>
        </table>
